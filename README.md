...
[pluscloud open](https://www.plusserver.com/en/product/pluscloud-open) is an open-source cloud service by [plusserver GmbH](https://plusserver.com). The technical documentation is published [here](https://docs.pco.get-cloud.io).
